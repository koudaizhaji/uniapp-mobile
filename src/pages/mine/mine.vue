<template>
  <view>
    <!-- 头部 -->
    <view class="relative flex h-310rpx">
      <!-- 右上角消息 -->
      <view
        class="i-dots-horizontal-circle-outline absolute top-75rpx right-20rpx text-white font-size-50rpx z-100"
      ></view>
      ...
      <view class="flex flex-items-center absolute left-0 right-0 bottom-50rpx">
        ...
        >
        <view
          class="flex flex-items-center justify-items-center flex-self-end ml-auto px-20rpx h-70rpx bg-#FFD43F c-#CC4A00 rounded-tl-40rpx rounded-bl-40rpx"
        >
          <view
    ...
    <!-- body -->
    <view class="w-100 flex flex-items-center justify-items-center py-20rpx bg-white">
      <view
        class="w-50% flex flex-col flex-column flex-items-center justify-items-center"
      >
        <text>福利金</text>
        <text>12.80</text>
      </view>
	...
	<view class="c-#eee w-100% bg-white mb-20rpx mt-20rpx">
    ...
    <!-- <uni-list-item :title="item.title" :showExtraIcon="item.showExtraIcon"
			...
			:leftIconStyle="item.leftIconStyle"></uni-list-item> -->
    <!-- </view> -->
    <button @click="login" class="bg-white mt-150rpx">去登录</button>
